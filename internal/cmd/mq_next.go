...
Examples:
  lt mq next gastown                    # Show highest-priority MR
  lt mq next gastown --strategy=fifo    # Show oldest MR instead
  lt mq next gastown --quiet            # Just print the MR ID
  lt mq next gastown --json             # Output as JSON`,
